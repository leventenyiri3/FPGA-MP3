...
Először is ki kell találni, hogy egy órajel alatt hány FFT-t kell megcsinálni, hány műveletvégző egység kell.

Layer III-nál két FFT-t kell párhuzamosan. Block length == window lenght.

\begin{description}
  \item[Short blocks] shift length = 192 samples, window length  = 256 samples
  \item[Long blocks] shift lenght = 576 samples, window lenght  = 1024 samples
\end{description}
...
Látszik, hogy a kisebb ablakok jobb felbontást biztosítanak időtartományban, a hosszabb ablakok pedig frekvencia tartományban.

A cél megtalálni az AMD által biztosított FFT core-nak azt a felparaméterezését, amely a lehető legkisebb erőforrás felhasználás nélkül teljesíteni tudja a követelményeket. 
...
Hosszú ablakoknál \(\frac{576}{44100} = 13.6 ms \) idő van FFT-re, rövidnél  \(\frac{192}{44100} = 4.35 ms \).
