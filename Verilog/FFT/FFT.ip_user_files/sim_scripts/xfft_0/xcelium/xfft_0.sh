...
#
# Script generated by Vivado on Sun Nov 30 11:47:45 CET 2025
...
#
# Usage        : xfft_0.sh
#                xfft_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xfft_0.sh [-reset_run]
#                xfft_0.sh [-reset_log]
#                xfft_0.sh [-help]
#
...
#                script (type 'xfft_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname c_reg_fd_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_7 -libname xbip_pipe_v3_0_10 -libname c_addsub_v12_0_20 -libname c_shift_ram_v12_0_19 -libname mult_gen_v12_0_23 -libname floating_point_v7_1_20 -libname cmpy_v6_0_26 -libname xfft_v9_1_14 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 c_shift_ram_v12_0_19 mult_gen_v12_0_23 floating_point_v7_1_20 cmpy_v6_0_26 xfft_v9_1_14 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xfft_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xfft_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xfft_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xfft_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/levente/git/Msc/FPGA-MP3/Verilog/FFT/FFT.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xfft_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: xfft_0.sh [-step]\n\
Usage: xfft_0.sh [-lib_map_path]\n\
Usage: xfft_0.sh [-reset_run]\n\
Usage: xfft_0.sh [-reset_log]\n\
Usage: xfft_0.sh [-keep_index]\n\
