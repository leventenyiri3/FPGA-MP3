...
design_libs=(xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 c_shift_ram_v12_0_19 mult_gen_v12_0_23 floating_point_v7_1_20 cmpy_v6_0_26 xfft_v9_1_14 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/levente/git/Msc/FPGA-MP3/Verilog/FFT/FFT.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key xfft_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xfft_0_simv.daidir vcs_lib c.obj)
